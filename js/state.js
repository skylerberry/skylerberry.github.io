...
export class AppState {
  ...
  captureTradeData() {
    ...
    return {
      ...
      trimRMultiple: inputs.trimRMultiple,
      trimPercentage: inputs.trimPercentage,

      // Calculated data
      shares: Number.parseFloat(results.shares.replace(/,/g, "")) || 0,
      positionSize: this.parseResultCurrency(results.positionSize),
      totalRisk: this.parseResultCurrency(results.totalRisk),
      rMultiple: Number.parseFloat(results.rMultiple.replace(" R", "")) || 0,
