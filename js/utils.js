...
export function parseFloat(value) {
    if (typeof value === 'string') {
        return globalThis.parseFloat(value.replace(/[$,]/g, '')) || 0;
    }
    return globalThis.parseFloat(value) || 0;
}
...
export function calculateShares(accountSize, riskPercentage, riskPerShare) {
    if (!isValidNumber(accountSize) || !isValidNumber(riskPercentage) || !isValidNumber(riskPerShare) || riskPerShare === 0) {
        return 0;
    }
